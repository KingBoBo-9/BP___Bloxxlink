...
boolean isCargoInElectricField() {
  for (int i = 0; i < numberOfObstacles; i++) {
    //top left
    if (cargoTargetCol == obstacleCol[i] -1 && cargoTargetRow == obstacleRow[i] -1) {
      return true;
    }
    //top
    if (cargoTargetRow == obstacleRow[i] -1 && cargoTargetCol == obstacleCol[i]) {
      return true;
    }
    //top right
    if (cargoTargetRow == obstacleRow[i] -1 && cargoTargetCol == obstacleCol[i] + 1) {
      return true;
    }
    //left
    if (cargoTargetCol == obstacleCol[i] -1 && cargoTargetRow == obstacleRow[i]) {
      return true;
    }
    //right
    if (cargoTargetCol == obstacleCol[i] +1 && cargoTargetRow == obstacleRow[i]) {
    ...
    //bottom
    if (cargoTargetCol == obstacleCol[i] && cargoTargetRow == obstacleRow[i] +1) {
      return true;
    }
    //bottom right
    if (cargoTargetCol == obstacleCol[i] +1 && cargoTargetRow == obstacleRow[i] +1) {
